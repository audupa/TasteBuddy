...
public class FragmentTabsPager extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(mTabHost.newTabSpec("Feeds").setIndicator("Feeds"),
                FeedsFragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("Nearby").setIndicator("Nearby Places"),
                NearbyPlacesFragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("MyRatings").setIndicator("My Ratings"),
                MyRatingsFragment.class, null);
